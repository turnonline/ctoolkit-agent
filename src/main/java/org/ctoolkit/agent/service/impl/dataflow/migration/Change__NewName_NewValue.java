...
/**
 * Use case - CHANGE - new name + new value
 *
 * @author <a href="mailto:pohorelec@comvai.com">Jozef Pohorelec</a>
 */
public class Change__NewName_NewValue
        extends UseCaseBase
{
    ...
    @Inject
    public Change__NewName_NewValue( IRuleStrategyResolver ruleStrategyResolver,
    ...
    public Value<?> value( MigrationSetKindOperation operation, Entity entity )
    {
        ...
        return decoder.decode( changeSetEntityProperty.getType(), operation.getMultiplicity(), operation.getNewValue() );
    }
