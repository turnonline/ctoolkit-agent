package org.ctoolkit.migration.agent.service.impl.datastore.rule;
 ...
 */
public class NewNameNewTypeNewValueChangeRule
        implements IChangeRule
{
    private EntityEncoder entityEncoder;

    @Inject
    public NewNameNewTypeNewValueChangeRule( EntityEncoder entityEncoder )
    {
