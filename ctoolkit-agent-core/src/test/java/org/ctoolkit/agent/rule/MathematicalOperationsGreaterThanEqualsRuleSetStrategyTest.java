 ...
 */
public class MathematicalOperationsGreaterThanEqualsRuleSetStrategyTest
{
    private RuleSetStrategy strategy = MathematicalOperationsRuleSetStrategy.INSTANCE_GTE;
