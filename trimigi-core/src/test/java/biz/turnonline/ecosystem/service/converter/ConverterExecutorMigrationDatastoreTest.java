...
import static biz.turnonline.ecosystem.Mocks.mockMigrationSetProperty;
import static biz.turnonline.ecosystem.service.converter.DatastoreConverterRegistrat.TYPE_BINARY;
import static biz.turnonline.ecosystem.service.converter.DatastoreConverterRegistrat.TYPE_BOOLEAN;
import static biz.turnonline.ecosystem.service.converter.DatastoreConverterRegistrat.TYPE_DATE;
import static biz.turnonline.ecosystem.service.converter.DatastoreConverterRegistrat.TYPE_DOUBLE;
import static biz.turnonline.ecosystem.service.converter.DatastoreConverterRegistrat.TYPE_KEY;
import static biz.turnonline.ecosystem.service.converter.DatastoreConverterRegistrat.TYPE_LAT_LNG;
import static biz.turnonline.ecosystem.service.converter.DatastoreConverterRegistrat.TYPE_LONG;
import static biz.turnonline.ecosystem.service.converter.DatastoreConverterRegistrat.TYPE_STRING;
import static org.junit.Assert.assertEquals;
import static org.mockito.Mockito.mock;
import static org.mockito.Mockito.when;

/**
 * Unit test for {@link ConverterExecutor} - datastore registrat - convert for migration
 *
 * @author <a href="mailto:pohorelec@turnonlie.biz">Jozef Pohorelec</a>
 */
public class ConverterExecutorMigrationDatastoreTest
{
    ...
    @Test
    public void test_LatLng()
    {
        MigrationSetProperty property = mockMigrationSetProperty( TYPE_LAT_LNG );
        ImportSetProperty importSetProperty = executor.convertProperty( new LatLng( 12.3, 14.5 ), property );

        assertEquals( "name", importSetProperty.getName() );
        assertEquals( "lat-lng", importSetProperty.getType() );
    ...
    {
        MigrationSetProperty property = mockMigrationSetProperty( TYPE_KEY );
        ImportSetProperty importSetProperty = executor.convertProperty( new RawKey( "Partner:1" ), property );

        assertEquals( "name", importSetProperty.getName() );
        assertEquals( "key", importSetProperty.getType() );
        assertEquals( "Partner:1", importSetProperty.getValue() );
    }
}