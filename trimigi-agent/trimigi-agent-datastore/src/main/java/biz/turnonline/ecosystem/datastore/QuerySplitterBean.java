...
/**
 * Copy of {@link com.google.datastore.v1.client.QuerySplitterImpl} because it does not provide public constructor
 *
 * @author <a href="mailto:pohorelec@turnonlie.biz">Jozef Pohorelec</a>
 */
@Singleton
public class QuerySplitterBean
        implements QuerySplitter
{
    ...
    private static final EnumSet<PropertyFilter.Operator> UNSUPPORTED_OPERATORS = EnumSet.of( PropertyFilter.Operator.LESS_THAN,
            PropertyFilter.Operator.LESS_THAN_OR_EQUAL, PropertyFilter.Operator.GREATER_THAN, PropertyFilter.Operator.GREATER_THAN_OR_EQUAL );
    ...
    private Query.Builder createScatterQuery( Query query, int numSplits )
    {
        ...
        scatterPointQuery.addOrder( DatastoreHelper.makeOrder(
                DatastoreHelper.SCATTER_PROPERTY_NAME, PropertyOrder.Direction.ASCENDING ) );
