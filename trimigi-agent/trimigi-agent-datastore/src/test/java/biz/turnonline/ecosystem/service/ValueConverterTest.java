...
import static biz.turnonline.ecosystem.Mocks.date;
import static biz.turnonline.ecosystem.Mocks.valueConverter;
...
public class ValueConverterTest
{
    ...
    public void convertFromDbLatLng()
    {
        ...
        assertEquals( 1, converted.size() );
        assertEquals( 12.3, ( ( biz.turnonline.ecosystem.model.LatLng ) converted.get( "property" ) ).getLatitude(), 0 );
        assertEquals( 14.8, ( ( biz.turnonline.ecosystem.model.LatLng ) converted.get( "property" ) ).getLongitude(), 0 );
    }
    ...
    {
        LatLngValue converted = ( LatLngValue ) converter.toValue( new biz.turnonline.ecosystem.model.LatLng( 12.3, 14.8 ) );
